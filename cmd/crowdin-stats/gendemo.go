...
func generateDemoSVGs() {
	...
	demoHostAllowed := func(host string) bool { return host == "i.pravatar.cc" }

	demoContributors := embedAvatarsAsDataURIsWith(context.Background(), avatarHTTPClient, demoHostAllowed, []Contributor{
